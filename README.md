# 👋 Olá, eu sou o **CoNnEcT500BR**
### (aka **Diego Pampuche**)

🎨 **Desenvolvedor Full Stack** com **foco em Frontend**  
🧠 Tenho experiência em backend — só não é meu foco principal  
...
- 💻 Atuo como **Full Stack**, mas minha paixão é o **Frontend**
- 🎮 Tenho interesse especial em **Frontend** e **Desenvolvimento de Jogos**
- 🛠️ Uso o GitHub como:
  - Portfólio
  - Área de estudos
  - APIs
...
### 🧪 Já tive experiência (não atualizado recentemente)
- Vue 3
- Angular
- Flutter
